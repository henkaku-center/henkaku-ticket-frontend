...
export declare namespace TicketV2 {
...
export interface TicketV2Interface extends utils.Interface {
  functions: {
...
export interface TicketV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TicketV2Interface;
  ...
  functions: {
    ...
    retrieveAllTickets(
      overrides?: CallOverrides
    ): Promise<[TicketV2.TicketInfoStructOutput[]]>;
