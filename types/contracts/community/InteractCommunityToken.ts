...
export interface InteractCommunityTokenInterface extends utils.Interface {
  functions: {
...
export interface InteractCommunityToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InteractCommunityTokenInterface;
